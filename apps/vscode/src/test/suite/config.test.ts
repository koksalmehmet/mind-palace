...
describe('Configuration Tests', () => {
  ...
  describe('Project Configuration (.palace/palace.jsonc)', () => {
    it('should merge project config with defaults', () => {
      ...
      const readFileStub = sandbox.stub(fs, 'readFileSync').returns(
        JSON.stringify(mockProjectConfig)
      );
    ...
    it('should prioritize project config over VS Code settings', () => {
      ...
      sandbox.stub(fs, 'readFileSync').returns(JSON.stringify(mockProjectConfig));
      sandbox.stub(fs, 'existsSync').returns(true);
  ...
  describe('Configuration Structure', () => {
    it('should have correct decoration config structure', () => {
      ...
      expect(config.decorations.style).to.be.oneOf(['gutter', 'inline', 'both']);
    });
    ...
    it('should have correct sidebar config structure', () => {
      ...
      expect(config.sidebar.graphLayout).to.be.oneOf(['cose', 'circle', 'grid', 'breadthfirst']);
    });
  });
});
